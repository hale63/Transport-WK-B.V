...
(function() {
  ...
  function switchLanguage(lang) {
    ...
    const desktopCode = document.getElementById('desktopLangCode');
    if (desktopCode) {
      desktopCode.textContent = lang.toUpperCase();
    }

    // Store preference
    localStorage.setItem('preferredLang', lang);

    // If your languageSwitcher.js exposes a function, call it here:
